...
{
    /// <inheritdoc />
    public partial class SchedulesAbsencesVacations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VacationAllowances_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkingDays = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AbsenceRequests_Users_DecidedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbsenceRequests_DecidedByUserId",
                table: "AbsenceRequests",
                column: "DecidedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AbsenceRequests_EmployeeId_StartDate",
                table: "AbsenceRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleAssignments_EmployeeId_StartDate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleSlots_ScheduleId_DayOfWeek",
                table: "ScheduleSlots",
                columns: new[] { "ScheduleId", "DayOfWeek" });

            migrationBuilder.CreateIndex(
                name: "IX_VacationAllowances_EmployeeId_Year",
