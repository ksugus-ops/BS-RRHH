        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToolsUsed = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ResponseStatus = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "EmployeeId",
                unique: true,
                filter: "[CheckOut] IS NULL AND [Status] = 1");
        }
